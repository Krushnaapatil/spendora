      ...
      <div className="relative mx-auto max-w-7xl px-6 py-28">
        <div className="max-w-3xl">
          ...
          <p className="mt-8 text-xl leading-9 text-zinc-600">
            Spendora analyzes plan fit, overlapping subscriptions, and pricing
            inefficiencies using deterministic rules - then generates an
            executive-readable summary for sharing.
          </p>
        </div>
        ...
        <div className="mt-20 grid gap-10 lg:grid-cols-[0.95fr_1.05fr]">
          <div className="rounded-[32px] border border-zinc-200 bg-white p-8 shadow-sm">
            ...
            <div className="mt-10 space-y-4">
              {[
                { tool: "ChatGPT Team", spend: "$240/mo" },
                { tool: "Claude Pro", spend: "$120/mo" },
                { tool: "Cursor Business", spend: "$160/mo" },
              ].map((tool) => (
                <div
                  key={tool.tool}
                ...
                >
                  ...
                  <p className="font-medium text-zinc-700">{tool.spend}</p>
                </div>
              ))}
            </div>
            ...
            <button
              ...
              disabled={isAuditing}
              className="mt-10 w-full rounded-2xl bg-zinc-950 px-6 py-4 text-lg font-semibold text-white transition hover:-translate-y-0.5 hover:bg-zinc-800 disabled:cursor-not-allowed disabled:opacity-60"
            >
              {isAuditing ? "Running audit..." : "Generate Audit"}
            </button>
          </div>
              ...
              <div>
                <div className="flex items-start justify-between gap-6">
                  <div>
                    ...
                    <h3 className="mt-4 text-5xl font-bold tracking-tight text-emerald-600">
                      $4,800
                    </h3>
                ...
                <div className="mt-8 rounded-3xl border border-zinc-200 bg-zinc-950 p-6 text-white">
                  <p className="text-sm font-semibold uppercase tracking-[0.2em] text-zinc-400">
                    AI-generated summary
                  </p>

                  <p className="mt-5 leading-8 text-zinc-300">
                    Your team is currently paying above the optimal pricing
                    threshold for Cursor Business while also missing available
                    startup credits for Claude usage. Adjusting both
                    subscriptions would reduce annual AI spend without affecting
