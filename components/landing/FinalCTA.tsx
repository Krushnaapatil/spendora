    ...
    <section className="relative overflow-hidden bg-zinc-950">
      ...
      <div className="relative mx-auto max-w-5xl px-6 py-28 text-center">
        ...
        <p className="mx-auto mt-8 max-w-3xl text-xl leading-9 text-zinc-400">
          Run a deterministic audit of your AI subscriptions, uncover
          overlapping tooling, and generate an executive-ready report in
          under 60 seconds.
        </p>
        ...
        <div className="mt-12 flex flex-col items-center justify-center gap-4 sm:flex-row">
          <button className="rounded-2xl bg-white px-8 py-4 text-lg font-semibold text-zinc-950 transition hover:bg-zinc-200">
            Run Free Audit
          </button>

          <button className="rounded-2xl border border-white/10 bg-white/5 px-8 py-4 text-lg font-semibold text-white backdrop-blur-sm transition hover:bg-white/10">
            See Example Report
          </button>
        </div>
